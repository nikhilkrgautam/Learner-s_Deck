...
export const GET_COURSE_PHYSICS_SUCCESS = "GET_COURSE_PHYSICS_SUCCESS";

export const GET_COURSE_MATHS_SUCCESS = "GET_COURSE_MATHS_SUCCESS";

export const GET_COURSE_CHEMISTRY_SUCCESS = "GET_COURSE_CHEMISTRY_SUCCESS";
...
export const VIDEOS_LOAD_ON = "VIDEOS_LOAD_ON";

export const VIDEOS_LOAD_OFF = "VIDEOS_LOAD_OFF";
...
export const GET_ALL_VIDEOS_ERR = "GET_ALL_VIDEOS_ERR";
